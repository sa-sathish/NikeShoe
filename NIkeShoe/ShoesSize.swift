    ...
    var body: some View {
        ...
        Button(action: {size = title}) {
            ...
            Text("\(title)")
                ...
                .background(size == title ? Color(UIColor(named: product.imageName)!) : Color.white)
                .clipShape(Circle())
        }
    }
}
...
extension UIColor {
    struct AppColors {
        static let blue = UIColor(hexString: "#DB5C44")
        static let silver = UIColor(hexString: "#dadae0")
    }
